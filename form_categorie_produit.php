<div class="wrapper">
          <div class="col-lg-12 jnt-mt">
            <h4><i class="fa fa-angle-right"></i> CREER UNE CATEGORIE PRODUIT</h4>
                ...
                <form class="cmxform form-horizontal style-form" id="signupForm" method="POST" action="">
                  ...
                  <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                      <button class="btn btn-theme" type="submit" name="creer_cate_produit">Enregistrer</button>
                      <button class="btn btn-theme04" type="submit">Annuler</button>
                    </div>
                  </div>
                </form>
              </div>
